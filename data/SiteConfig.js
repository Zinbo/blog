const config = {
  ...
  siteDescription:
    'A blog on everything backend and mobile related.', // Website description used for RSS feeds/meta description tag.
  ...
  userDescription:
    "User descript", // User description to display in the author segment.
